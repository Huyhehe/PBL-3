        ...
        <div class="commodity-container">
          ...
          >
            <div class="commodity-card">
              ...
              <!-- <div class="card-button-bg-blur"></div> -->
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      await this.$store.dispatch("fetchCommodityList");
      this.commodityList = this.getAllCommodity;
      this.$store.commit("ADD_COMMODITY", false);
    ...
    async deleteCommodity(id) {
      ...
      if (!this.$store.getters.getDeleteSuccessful) {
        const alert = document.querySelector(".error-alert");
        alert.classList.add("show");
        this.alertMessage();
        return;
      ...
      await this.$store.dispatch("fetchCommodityList");
      this.commodityList = this.getAllCommodity;
      this.$store.commit("DELETE_COMMODITY", false);
    },
    ...
    async update() {
      ...
      if (!this.$store.getters.getUpdateSuccessful) {
        const alert = document.querySelector(".error-alert");
        alert.classList.add("show");
        this.alertMessage();
        return;
      ...
      this.$store.commit("UPDATE_COMMODITY", false);
      this.back();
    },
    formatMoney(num) {
      num = +num;
    ...
    addToCart(commodity) {
      ...
      this.$store.commit(
        "SET_WARNING_MESSAGE",
        "Stuff has just been added to cart!"
      );
      const alert = document.querySelector(".success-alert");
      alert.classList.add("show");
      this.okMessage();
